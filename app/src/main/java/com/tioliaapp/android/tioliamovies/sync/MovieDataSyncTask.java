...
public class MovieDataSyncTask {
    ...
    // In addition to this, this will notify the user that new movie data has been loaded
    ...
    synchronized public static void syncMovieData(Context context) {
        ...
        try {
            ...
            if (popularMovieValues != null && popularMovieValues.length != 0) {
                ...
                // Deletes old movie data because there is no need to keep multiple movies data
                contentResolver.delete(
                        PopularMovieEntry.CONTENT_URI,
                        null,
                        null);

                // Inserts new movie data into ContentProvider
